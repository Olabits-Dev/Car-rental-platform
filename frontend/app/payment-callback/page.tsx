    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-lg">
        ...
        {status === "success" && (
          <>
            <div className="mb-4 flex justify-center">
              <div className="flex items-center justify-center rounded-full bg-green-100 h-16 w-16">
                <svg
        ...
        {status === "failed" && (
          <>
            <div className="mb-4 flex justify-center">
              <div className="flex items-center justify-center rounded-full bg-red-100 h-16 w-16">
                <svg
            ...
            <button
              ...
              className="inline-block rounded bg-[#d61032] px-6 py-2 text-white font-semibold hover:bg-[#b00028]"
            >
              Return to Dashboard
            </button>
          </>
